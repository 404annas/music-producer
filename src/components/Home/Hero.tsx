...
const Hero = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden flex flex-col justify-between items-center">
      ...
      <div className="relative z-20 flex-grow flex flex-col justify-center items-center px-6 text-center max-w-4xl mt-40">
      ...
      <div className="relative z-20 w-full text-center select-none pb-4 md:pb-10">
